...
| 6 | 1:40–2:05 | `/allowance` | Open split stream: 101 STRK over days to Ava+Ben, shares 7:3 | "stream opened ✓ tx <hash>"; recipients weighted | "Allowances drip second by second — one stream, split by share between siblings." |
| 7 | 2:05–2:25 | `/stash` (kid tab) | Ava opens stash → **Scoop** | Accrued amount counted up, scoop pays everything not yet scooped | "Kids scoop their allowance whenever they like — accrued to the second, claimed privately." |
